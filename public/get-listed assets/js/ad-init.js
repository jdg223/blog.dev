			...
			init: function() {
				...
				// Skel.
					skel.init({
						...
						containers: '100%',
						breakpoints: {
							global: { range: '*', href: 'css/ad-style.css' },
							desktop: { range: '737-', href: 'css/ad-style-desktop.css', viewport: { width: 1280, scalable: false } },
							mobile: { range: '-736', href: 'css/ad-style-mobile.css', viewport: { scalable: false } }
						}
					});
