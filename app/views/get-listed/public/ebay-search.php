...
$appid = 'Garza54c8-cf77-4dc4-a7e0-bb8b0f3c8d3';  // Replace with your own AppID
$globalid = 'EBAY-US';  // Global ID of the eBay site you want to search (e.g., EBAY-DE)
$query = 'apple';  // You may want to supply your own query
...
<html lang="en">
  <head>
    ...
    <!-- Bootstrap core CSS -->
    <link href="get-listed assets/css/bootstrap.css" rel="stylesheet">
    <!--external css-->
    <link href="get-listed assets/css/font-awesome.css" rel="stylesheet" />
        
    <!-- Custom styles for this template -->
    <link href="get-listed assets/css/dash-style.css" rel="stylesheet">
    <link href="get-listed assets/css/style-responsive.css" rel="stylesheet">
      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
              	  ...
              	  <p class="centered"><a href="profile.html"><img src="get-listed assets/img/ui-sam.jpg" class="img-circle" width="60"></a></p>
              	  <h5 class="centered">John Dilli Pickle</h5>
